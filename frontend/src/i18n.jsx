...
const translations = {
  en: {
    ...
    'support.chat.button': 'Support chat',
    'support.chat.title': 'Support chat',
    'support.chat.subtitle': 'Private help for your account and orders',
    'support.chat.close': 'Close',
    'support.chat.connected': 'Connected',
    'support.chat.connecting': 'Connecting...',
    'support.chat.disconnected': 'Offline',
    'support.chat.sign_in': 'Sign in to open support chat',
    'support.chat.connection_error': 'Unable to connect to support chat',
    'support.chat.send_error': 'Unable to send message',
    'support.chat.empty_title': 'Start a support conversation',
    'support.chat.empty_text': 'Ask a question about your order, account, or delivery and support will reply here.',
    'support.chat.placeholder': 'Write your message...',
    'support.chat.send': 'Send',
    'support.chat.you': 'You',
    'support.chat.agent': 'Support',
    'support.chat.sending': 'Sending...',
    'support.chat.account_scoped': 'Messages are linked to this account only',
    'support.chat.live': 'Live',
    'support.chat.queued': 'Queued',
    'support.chat.quick_action': 'Open your private support thread',
  ...
  ru: {
    ...
    'support.chat.button': 'Чат поддержки',
    'support.chat.title': 'Чат поддержки',
    'support.chat.subtitle': 'Личная помощь по аккаунту и заказам',
    'support.chat.close': 'Закрыть',
    'support.chat.connected': 'Подключено',
    'support.chat.connecting': 'Подключение...',
    'support.chat.disconnected': 'Оффлайн',
    'support.chat.sign_in': 'Войдите, чтобы открыть чат поддержки',
    'support.chat.connection_error': 'Не удалось подключиться к чату поддержки',
    'support.chat.send_error': 'Не удалось отправить сообщение',
    'support.chat.empty_title': 'Начните диалог с поддержкой',
    'support.chat.empty_text': 'Задайте вопрос о заказе, аккаунте или доставке, и поддержка ответит здесь.',
    'support.chat.placeholder': 'Напишите сообщение...',
    'support.chat.send': 'Отправить',
    'support.chat.you': 'Вы',
    'support.chat.agent': 'Поддержка',
    'support.chat.sending': 'Отправка...',
    'support.chat.account_scoped': 'Сообщения привязаны только к этому аккаунту',
    'support.chat.live': 'В сети',
    'support.chat.queued': 'В очереди',
    'support.chat.quick_action': 'Открыть личный диалог поддержки',
